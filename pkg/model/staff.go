...
type Department struct {
	...
	DepartmentLocation    string  `gorm:"type:varchar(50)" json:"department_location" form:"department_location" cn:"部门地点"`
	DepartmentManagerID   int     `gorm:"type:int;index"  json:"department_manager_id" form:"department_manager_id" cn:"部门主管ID"`
	DepartmentManagerName string  `gorm:"type:varchar(50)"  json:"department_manager_name" form:"department_manager_name" cn:"部门主管名称"`
