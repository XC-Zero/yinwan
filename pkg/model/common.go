...
type BasicModel struct {
	RecID     *int           `gorm:"primaryKey;type:int;autoIncrement" json:"id,omitempty" bson:"rec_id" cn:"记录ID"`
	...
	DeletedAt gorm.DeletedAt `gorm:"index" json:"deleted_at" bson:"deleted_at" cn:"删除时间"`
}
