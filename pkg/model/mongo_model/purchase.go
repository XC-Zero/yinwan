...
type Purchase struct {
	...
	ProviderID               *int                      `json:"provider_id,omitempty" form:"provider_id" binding:"required" bson:"provider_id" cn:"供应商编号"`
	ProviderName             *string                   `json:"provider_name,omitempty" form:"provider_name" binding:"required" bson:"provider_name" cn:"供应商名称"`
	...
	PurchaseTotalAmount      string                    `json:"purchase_total_amount" form:"purchase_total_amount" bson:"purchase_total_amount" binding:"required" cn:"总金额"`
	PurchaseTotalIncludedTax string                    `json:"purchase_total_included_tax" form:"purchase_total_included_tax" bson:"purchase_total_included_tax" binding:"required" cn:"含税总额"`
	PurchaseContent          *[]map[string]interface{} `json:"purchase_content" form:"purchase_content" bson:"purchase_content" cn:"采购内容"`
	PurchaseDate             *string                   `json:"purchase_date" form:"purchase_date" bson:"purchase_date" binding:"required" cn:"采购日期"`
	Remark                   *string                   `json:"remark,omitempty" form:"remark,omitempty" bson:"remark" cn:"备注"`
	//PurchaseTaxRate          string                    `json:"purchase_tax_rate" form:"purchase_tax_rate" bson:"purchase_tax_rate" binding:"required" cn:"采购税率"`
	//PurchaseTax              string                    `json:"purchase_tax" form:"purchase_tax" bson:"purchase_tax" binding:"required" cn:"采购税额"`
}
